...
\begin{footnotesize}
This research was supported by the Austrian Federal Ministry of Transport, Innovation and Technology (BMVIT) under the program "ICT of the Future" within the project SemEO (contract no: 855467).
\end{footnotesize}
